...
DONE_CHANNEL_ID = 1541145294643798228     # <--- Bddel had l-ID b-ID dyal #done channel
FEEDBACK_CHANNEL_ID = 1538901961448099960 # <--- Bddel had l-ID b-ID dyal #feedbacks channel
...
@app_commands.choices(product=[
    ...
    app_commands.Choice(name="Project Ticket", value="Ticket")
])
